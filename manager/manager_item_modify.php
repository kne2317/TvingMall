	...
	<head>
        ...
        <script>
            function btn_click(str){                             
                if(str=="update"){                                 
                    frm1.action="update.php";      
                } else if(str=="delete"){      
                    frm1.action="delete.php";      
                }
            }
        </script>
	...
	<body>
		<nav>
			<ul>
				...
				<a href="manager_item.php"><li style="font-size:18pt; color:white;">상품수정/삭제</li></a>
		...
		<section>
            <form action="update.php?id=<?php echo $_GET['id'];?>" method="post" enctype="multipart/form-data">
                <input type="text" name="name" placeholder="상품명" style="padding:1em; margin:1em; width:40em;">
                ...
                <input type="text" name="price" placeholder="상품 가격 ( , 없이 입력 )"  style="padding:1em;  margin:1em;width:40em;">원
                <br>

                <input type="text" name="sale" placeholder="상품 할인율 ( 할인상품이 아닐 경우 0입력 )" style="padding:1em;  margin:1em;width:40em;">%
                ...
                <select name="category" style="padding:1em;  margin:1em;width:40em;">
                    <optgroup label="굿즈">
                        ...
                        <option value="art_goods">아티스트 굿즈</option>
                ...
                <button type="submit" name="update_btn" style="padding:1em; width:40em; margin:1em;">수정</button>
                <br>
                

            </form>
            <form action="delete.php?id=<?php echo $_GET['id']?>" method="post" enctype="multipart/form-data">
                <button type="submit" name="delete_btn" style="padding:1em; width:40em; margin:1em;">삭제</button>
            </form>
