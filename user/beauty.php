...
<html>
	...
	<body>
		...
		<content>
            ...
            <div id ="nav_category">
                <ul>
                    ...
                    <a href="javascript:togglememo('item_category_2');"><li>스킨/케어</li></a>
                    <a href="javascript:togglememo('item_category_3');"><li>메이크업</li>
                    <a href="javascript:togglememo('item_category_4');"><li>미용소품</li></a>
                    <a href="javascript:togglememo('item_category_5');"><li>바디/헤어케어</li></a>
                    <a href="javascript:togglememo('item_category_6');"><li>향수</li></a>
                    <a href="javascript:togglememo('item_category_7');"><li>남성뷰티</li></a>
                </ul>
            </div>

            <div class="contT2" id="item_category_1" >
                <?php
                    $sql = "select * from item where category='care' or category='makeup' or category='hair' or category='body' or category='perfume' or category='man'";
        ...
        <div class="contT2" id="item_category_2" style="display:none;">
                <?php
                    $sql = "select * from item where category='care'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_3"style="display:none;">
                <?php
                    $sql = "select * from item where category='makeup'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_4"style="display:none;">
                <?php
                    $sql = "select * from item where category='hair'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_5"style="display:none;">
                <?php
                    $sql = "select * from item where category='body'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_6"style="display:none;">
                <?php
                    $sql = "select * from item where category='perfume'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_7"style="display:none;">
                <?php
                    $sql = "select * from item where category='man'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
