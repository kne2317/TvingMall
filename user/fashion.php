...
<html>
	...
	<body>
		...
		<content>
            ...
            <div id ="nav_category">
                <ul>
                    ...
                    <a href="javascript:togglememo('item_category_2');"><li>옷</li></a>
                    <a href="javascript:togglememo('item_category_3');"><li>잡화</li>
                    <a href="javascript:togglememo('item_category_4');"><li>악세사리</li></a>
                </ul>
            </div>

            <div class="contT2" id="item_category_1">
                <?php
                    $sql = "select * from item where category='fashion' or category='clothes' or category='bag' or category='jewelry'";
        ...
        <div class="contT2" id="item_category_2" style="display:none;">
                <?php
                    $sql = "select * from item where category='clothes'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_3"style="display:none;">
                <?php
                    $sql = "select * from item where category='bag'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_4"style="display:none;">
                <?php
                    $sql = "select * from item where category='jewelry'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
