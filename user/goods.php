...
<html>
	<head>
        ...
        <script>
            function togglememo(iObject)  {
                ...
                var con5 = document.getElementById('item_category_5');
                var con6 = document.getElementById('item_category_6');
                var con7 = document.getElementById('item_category_7');
                ...
                if (obj != con5)  con5.style.display = "none";
                if (obj != con6)  con6.style.display = "none";
                if (obj != con7)  con7.style.display = "none";
	...
	<body>
		...
		<content>
            ...
            <div id ="nav_category">
                <ul>
                    ...
                    <a href="javascript:togglememo('item_category_2');"><li>방송영화애니굿즈</li></a>
                    <a href="javascript:togglememo('item_category_3');"><li>아티스트 굿즈</li>
                    <a href="javascript:togglememo('item_category_4');"><li>캐릭터/웹툰/크리에이터 굿즈</li></a>
                    <a href="javascript:togglememo('item_category_5');"><li>CD/DVD/LP</li></a>
                    <a href="javascript:togglememo('item_category_6');"><li>대본집/스토리북</li></a>
                    <a href="javascript:togglememo('item_category_7');"><li>악보집</li></a>
                </ul>
            </div> 

            <div class="contT2" id="item_category_1" >
                <?php
                    $sql = "select * from item where category='movie_goods' or category='art_goods' or category='char_goods' or category='cd_goods' or category='book_goods' or category='music_goods'";
        ...
        <div class="contT2" id="item_category_2" style="display:none;">
            <?php
                $sql = "select * from item where category='movie_goods'";
                $result=mysqli_query($conn, $sql);
                item_create($result);
            ?>
        </div>
        <div class="contT2" id="item_category_3"style="display:none;">
            <?php
                $sql = "select * from item where category='art_goods'";
                $result=mysqli_query($conn, $sql);
                item_create($result);
            ?>
        </div>
        <div class="contT2" id="item_category_4"style="display:none;">
            <?php
                $sql = "select * from item where category='char_goods'";
                $result=mysqli_query($conn, $sql);
                item_create($result);
            ?>
        </div>
        <div class="contT2" id="item_category_5"style="display:none;">
            <?php
                $sql = "select * from item where category='cd_goods'";
                $result=mysqli_query($conn, $sql);
                item_create($result);
            ?>
        </div>
        <div class="contT2" id="item_category_6"style="display:none;">
            <?php
                $sql = "select * from item where category='book_goods'";
                $result=mysqli_query($conn, $sql);
                item_create($result);
            ?>
        </div>
        <div class="contT2" id="item_category_7"style="display:none;">
            <?php
                $sql = "select * from item where category='music_goods'";
                $result=mysqli_query($conn, $sql);
                item_create($result);
            ?>
        </div>
