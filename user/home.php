...
<html>
	...
	<body>
		...
		<content>
            ...
            <div id ="nav_category">
                <ul>
                    ...
                    <a href="javascript:togglememo('item_category_2');"><li>대형가전</li></a>
                    <a href="javascript:togglememo('item_category_3');"><li>빔프로젝터</li>
                    <a href="javascript:togglememo('item_category_4');"><li>계절가전</li></a>
                    <a href="javascript:togglememo('item_category_5');"><li>주방가전</li></a>
                    <a href="javascript:togglememo('item_category_6');"><li>생활/소형가전</li></a>
                </ul>
            </div>

            <div class="contT2" id="item_category_1">
                <?php
                    $sql = "select * from item where category='home' 
                    or category='bighome' or category='bimproject' 
                    or category='seasonhome' or category='kitchenhome' 
                    or category='lifehome'";
        ...
        <div class="contT2" id="item_category_2"style="display:none;">
                <?php
                    $sql = "select * from item where category='bighome'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_3"style="display:none;">
                <?php
                    $sql = "select * from item where category='bimproject'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_4"style="display:none;">
                <?php
                    $sql = "select * from item where category='seasonhome'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_5"style="display:none;">
                <?php
                    $sql = "select * from item where category='kitchenhome'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_6"style="display:none;">
                <?php
                    $sql = "select * from item where category='lifehome'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>	
