...
<html>
	...
	<body>
		...
		<content>
            ...
            <div id ="nav_category">
                <ul>
                    ...
                    <a href="javascript:togglememo('item_category_2');"><li>학습완구/교구/책</li></a>
                    <a href="javascript:togglememo('item_category_3');"><li>보드게임</li>
                    <a href="javascript:togglememo('item_category_4');"><li>침구/인테리어</li></a>
                    <a href="javascript:togglememo('item_category_5');"><li>인형/장난감</li></a>
                    <a href="javascript:togglememo('item_category_6');"><li>키즈의류</li></a>
                    <a href="javascript:togglememo('item_category_7');"><li>키즈잡화</li>
                    <a href="javascript:togglememo('item_category_8');"><li>이유식용품</li></a>
                    <a href="javascript:togglememo('item_category_9');"><li>물놀이용품</li></a>
                    <a href="javascript:togglememo('item_category_10');"><li>위생안전용품</li>
                    <a href="javascript:togglememo('item_category_11');"><li>신비아파트</li></a>
                </ul>
            </div>
            ...
            <div class="contT2" id="item_category_1">
                <?php
                    ...
                    or category='kids_book' or category='kids_boardgame' 
                    or category='kids_interior' or category='kids_doll' 
                    or category='kids_cloth' or category='kids_etc' 
                    or category='kids_baby' or category='kids_water' 
                    or category='kids_safe' or category='sinby'";
        ...
        <div class="contT2" id="item_category_2"style="display:none;">
                <?php
                    $sql = "select * from item where category='kids_book'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_3"style="display:none;">
                <?php
                    $sql = "select * from item where category='kids_boardgame'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_4"style="display:none;">
                <?php
                    $sql = "select * from item where category='kids_interior'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_5"style="display:none;">
                <?php
                    $sql = "select * from item where category='kids_doll'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_6"style="display:none;">
                <?php
                    $sql = "select * from item where category='kids_cloth'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_7"style="display:none;">
                <?php
                    $sql = "select * from item where category='kids_etc'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_8"style="display:none;">
                <?php
                    $sql = "select * from item where category='kids_baby'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_9"style="display:none;">
                <?php
                    $sql = "select * from item where category='kids_water'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_10"style="display:none;">
                <?php
                    $sql = "select * from item where category='kids_safe'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_11"style="display:none;">
                <?php
                    $sql = "select * from item where category='sinby'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
