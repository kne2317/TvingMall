...
<html>
	...
	<body>
		...
		<content>
            ...
            <div id ="nav_category">
                <ul>
                    ...
                    <a href="javascript:togglememo('item_category_2');"><li>도서</li></a>
                    <a href="javascript:togglememo('item_category_3');"><li>리빙</li>
                    <a href="javascript:togglememo('item_category_4');"><li>생활/건강</li></a>
                    <a href="javascript:togglememo('item_category_5');"><li>푸드</li></a>
                    <a href="javascript:togglememo('item_category_6');"><li>디자인문구</li></a>
                    <a href="javascript:togglememo('item_category_7');"><li>티켓/이용권</li>
                    <a href="javascript:togglememo('item_category_8');"><li>레저/스포츠</li></a>
                </ul>
            </div>

            <div class="contT2" id="item_category_1">
                <?php
                    $sql = "select * from item where category='life' or category='book' or category='living' 
                    or category='health' or category='food' or category='design' or category='ticket' 
                    or category='sports'";
        ...
        <div class="contT2" id="item_category_3"style="display:none;">
                <?php
                    $sql = "select * from item where category='living'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_4"style="display:none;">
                <?php
                    $sql = "select * from item where category='health'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_5"style="display:none;">
                <?php
                    $sql = "select * from item where category='food'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_6"style="display:none;">
                <?php
                    $sql = "select * from item where category='design'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
        <div class="contT2" id="item_category_7"style="display:none;">
                <?php
                    $sql = "select * from item where category='ticket'";
                    $result=mysqli_query($conn, $sql);
                    item_create($result);
                ?>
        </div>
